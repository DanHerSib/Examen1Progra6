...
VALUES
(1, 'FISICO',1),
(2, 'JURIDICO',1)) AS TEMP (Id_TipoInquilino, Descripcion, Estado)

----ACTUALIZAR DATOS---
UPDATE TI SET
  TI.Descripcion = TM.Descripcion, TI.Estado = TM.Estado
...
SET IDENTITY_INSERT dbo.TipoInquilino ON
    INSERT INTO dbo.TipoInquilino(Id_TipoInquilino, Descripcion, Estado)
    SELECT
